...
The app needs to run on Linux, macOS, and Windows with a lightweight UI, global trigger support, clipboard integration, local settings, and access to native microphone capture.
...
The frontend will own presentation and interaction. The Rust backend will own microphone capture, provider streaming, shortcut handling, clipboard integration, and secret access.
